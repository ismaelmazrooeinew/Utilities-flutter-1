...
extension RxPageStateExtension on Rx<PageState> {
  bool isLoading() => this.value == PageState.loading;

  bool isLoaded() => this.value == PageState.loaded;

  bool isInitial() => this.value == PageState.initial;

  bool isError() => this.value == PageState.error;

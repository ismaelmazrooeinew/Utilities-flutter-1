...
//     return delimenters.isEmpty ? [this] : this.split(RegExp(delimenters.map(RegExp.escape).join('|')));
//   }
// }
//
...
//     this.tagDecoration = const BoxDecoration(color: Color.fromARGB(255, 74, 137, 92)),
//     this.tagTextStyle,

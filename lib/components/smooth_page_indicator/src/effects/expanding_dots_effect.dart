...
import 'package:utilities/components/smooth_page_indicator/src/painters/expanding_dots_painter.dart';
...
class ExpandingDotsEffect extends BasicIndicatorEffect {
  ...
  const ExpandingDotsEffect({
    ...
    PaintingStyle paintStyle = PaintingStyle.fill,
        ...
        super(dotWidth: dotWidth, dotHeight: dotHeight, spacing: spacing, radius: radius, strokeWidth: strokeWidth, paintStyle: paintStyle, dotColor: dotColor, activeDotColor: activeDotColor);

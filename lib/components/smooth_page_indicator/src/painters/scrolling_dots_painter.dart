...
import 'package:utilities/components/smooth_page_indicator/src/effects/scrolling_dots_effect.dart';
...
class ScrollingDotsPainter extends BasicIndicatorPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final firstVisibleDot = (current < switchPoint || count - 1 < effect.maxVisibleDots) ? 0 : min(current - switchPoint, count - effect.maxVisibleDots);
    ...
    final drawingAnchor = (inPreScrollRange || inAfterScrollRange) ? -(firstVisibleDot * distance) : -((offset - switchPoint) * distance);

...
class AppSettingsDtoV2 {
  ...
  factory AppSettingsDtoV2.fromJson(String str) => AppSettingsDtoV2.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AppSettingsDtoV2.fromMap(Map<String, dynamic> json) => AppSettingsDtoV2(

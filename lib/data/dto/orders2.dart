...
class OrdersReadDto2 {
  ...
  factory OrdersReadDto2.fromJson(String str) => OrdersReadDto2.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory OrdersReadDto2.fromMap(Map<String, dynamic> json) => OrdersReadDto2(
